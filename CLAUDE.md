...
- **Docs (master):** `~/ob/kmr/prj/ClaudiMux/Docket/Anchorage/` — the **Anchorage** subsystem (slug `ANC`, a federated child of Docket), incl. `ANC Standard` (standard), `ANC API` (API surface), `ANC Architecture`, `ANC Roadmap`. Master page: `Anchorage.md`.
